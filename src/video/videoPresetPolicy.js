...
export function getRelocatedReviewPresetConfig() {
    return {
        id: 'relocated-review',
        label: 'AI Auto Preset (Relocated)',
        description: 'Auto-detects watermark position and suppresses it using AI, without manual tuning.',
...
export function getStandardAutoPresetConfig() {
    return {
        id: 'standard-auto',
        label: 'AI Auto Preset',
        description: 'Default local AI preset for processing bottom-right Gemini/Veo watermarks.',
        alphaGain: DEFAULT_AUTO_ALPHA_GAIN,
        adaptiveAlpha: false,
        highQualityCleanup: DEFAULT_HIGH_QUALITY_CLEANUP,
